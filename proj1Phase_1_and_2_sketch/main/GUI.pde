...
void keyPressed()  // executed each time a key is pressed: sets the Boolean "keyPressed" till it is released   
    ...
    //if(key=='j') ; //used to toggle visibility of triangle in myProject part1
    //if(key=='k') ; //used to toggle visibility of triangle in myProject part1
    //if(key=='l') ; //used to toggle visibility of triangle in myProject part1
    ...
    //if(key=='p') ;
    //if(key=='q') ; //used to toggle visibility of quadrilateral in myProject part1
    //if(key=='r') ; // 
